...
#include "FiniteStateMachine/fsm_own.h"
...
{   
    ...
    {   
        printf("+-----------------------------------------------------------------+\n");
        printf("|   q: GPIO |  w: +y   | l: light |  r: +z  | t: tran1 | z: state |\n");
        printf("|-----------+----------+----------+---------+----------+----------|\n");
...
{       
    ...
    Eigen::VectorXd torque_total(dof); torque_total.setZero();
        ...
        {   
            ...
            switch(fsm.state)
            {
                ...
                case FSM_TASK1 :
                    ...
                    break;
                case FSM_TASK2 :
                    targetQ = fsm.Task2(key,is_key_updated, currentQ, fd_gpio_30, fd_gpio_31); 
                    break;
                case FSM_TASK3 :
